let icon = document.querySelector(".icon");  // use for add Home,Shop,review,blogs etc. in bar icon.
let ul = document.querySelector("ul");

icon.addEventListener("click", ()=>{
    ul.classList.toggle("showData"); //toggle is use to show then hide then show then hide showData .
    
    if(ul.className == "showData"){
        document.getElementById("bar").className= "fa-solid fa-xmark";
        // use to add X(cross icon) in bar icon.
    }else{
